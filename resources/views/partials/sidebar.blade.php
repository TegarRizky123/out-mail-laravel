<div class="container-fluid">
      ...
      <div class="row" style="height: 660px;">
        <div class="sidebar col-md-3 col-sm-3 d-md-block d-sm-block d-none" style="background-image: linear-gradient(to bottom left, #000106,#34dee2);">
          <div class="row text-center">
            <div class="col-md-11 mt-3 ">
              <img class="rounded-circle ms-3"src="images/simpson.jpg" alt="" width="150px" height="150px"> <br>
              <p class="text-white fw-bold ms-3 fs-3 mt-2">OutMail App</p>
            </div>
            <div class="col-md-1 mt-5 mb-5">
              ...
              <div class="mt-2">
                <ul class="navbar-nav">
                  ...
                  <li class="{{ ($title === "Profile") ? 'active' : 'passive'}}">
                    <div class="my-4">
                      <a href="/profile" class="menu-active text-decoration-none text-white">
        ...
        <div class="col-md-3 col-sm-3 d-md-none d-sm-none d-block">
           <nav class="navbar tembus navbar-dark bg-info navbar-expand d-md-none d-lg-none d-xl-none fixed-bottom" style="background-image: linear-gradient(to bottom left, #000106,#34dee2);">
        ...
        <div class="home col-md-8 col-sm-8 col-12" style="background-image: linear-gradient(to bottom left,#ffffff);">
              @yield('content')
        </div>
      </div>
    </div>